...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 3 - ((2 * winheight(0) + 51) / 103)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3
...
exe '2resize ' . ((&lines * 36 + 52) / 105)
exe 'vert 2resize ' . ((&columns * 224 + 160) / 321)
exe '3resize ' . ((&lines * 65 + 52) / 105)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 11 - ((5 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
11
