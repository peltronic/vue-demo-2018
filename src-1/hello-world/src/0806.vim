...
badd +1 components/VideoSlider.vue
...
exe 'vert 1resize ' . ((&columns * 88 + 160) / 321)
exe '2resize ' . ((&lines * 59 + 52) / 105)
exe 'vert 2resize ' . ((&columns * 88 + 160) / 321)
exe '3resize ' . ((&lines * 20 + 52) / 105)
exe 'vert 3resize ' . ((&columns * 232 + 160) / 321)
exe '4resize ' . ((&lines * 81 + 52) / 105)
exe 'vert 4resize ' . ((&columns * 232 + 160) / 321)
argglobal
...
argglobal
2argu
edit components/VideoSlider.vue
nnoremap <buffer> <silent> [] :call search('^</\(template\|script\|style\)', 'bW')
nnoremap <buffer> <silent> [[ :call search('^<\(template\|script\|style\)', 'bW')
nnoremap <buffer> <silent> ][ :call search('^</\(template\|script\|style\)', 'W')
nnoremap <buffer> <silent> ]] :call search('^<\(template\|script\|style\)', 'W')
...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 96 + 160) / 321)
exe '2resize ' . ((&lines * 28 + 52) / 105)
exe 'vert 2resize ' . ((&columns * 224 + 160) / 321)
exe '3resize ' . ((&lines * 52 + 52) / 105)
exe 'vert 3resize ' . ((&columns * 224 + 160) / 321)
exe '4resize ' . ((&lines * 20 + 52) / 105)
exe 'vert 4resize ' . ((&columns * 224 + 160) / 321)
argglobal
4argu
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 61 - ((21 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 10 - ((5 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 160 + 160) / 321)
exe 'vert 2resize ' . ((&columns * 160 + 160) / 321)
argglobal
1argu
edit tmp.txt
setlocal keymap=
...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 78 + 160) / 321)
exe 'vert 2resize ' . ((&columns * 242 + 160) / 321)
argglobal
7argu
nnoremap <buffer> <silent> [] :call search('^</\(template\|script\|style\)', 'bW')
nnoremap <buffer> <silent> [[ :call search('^<\(template\|script\|style\)', 'bW')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 20 - ((19 * winheight(0) + 51) / 102)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
20
...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe '1resize ' . ((&lines * 38 + 52) / 105)
exe 'vert 1resize ' . ((&columns * 98 + 160) / 321)
exe '2resize ' . ((&lines * 63 + 52) / 105)
exe 'vert 2resize ' . ((&columns * 98 + 160) / 321)
exe '3resize ' . ((&lines * 53 + 52) / 105)
exe 'vert 3resize ' . ((&columns * 222 + 160) / 321)
exe '4resize ' . ((&lines * 48 + 52) / 105)
exe 'vert 4resize ' . ((&columns * 222 + 160) / 321)
argglobal
5argu
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 11 - ((5 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
11
