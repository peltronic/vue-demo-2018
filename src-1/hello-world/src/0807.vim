...
badd +1 tmp.txt
badd +0 HERE.txt
badd +0 components/TourPreview.vue
argglobal
silent! argdel *
$argadd App.vue
...
exe '3resize ' . ((&lines * 54 + 52) / 105)
exe 'vert 3resize ' . ((&columns * 232 + 160) / 321)
exe '4resize ' . ((&lines * 47 + 52) / 105)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 92 - ((45 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
92
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 21 - ((20 * winheight(0) + 51) / 102)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
exe '2resize ' . ((&lines * 96 + 52) / 105)
exe 'vert 2resize ' . ((&columns * 224 + 160) / 321)
exe '3resize ' . ((&lines * 1 + 52) / 105)
exe 'vert 3resize ' . ((&columns * 224 + 160) / 321)
exe '4resize ' . ((&lines * 3 + 52) / 105)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 208 - ((74 * winheight(0) + 48) / 96)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
208
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 75 - ((64 * winheight(0) + 51) / 102)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
75
...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe '1resize ' . ((&lines * 68 + 52) / 105)
exe 'vert 1resize ' . ((&columns * 98 + 160) / 321)
exe '2resize ' . ((&lines * 33 + 52) / 105)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 11 - ((5 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
11
