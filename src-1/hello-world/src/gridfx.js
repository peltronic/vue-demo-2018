 ...
 * GridFx object
 */
export default function GridFx(el, options) {
    console.log('init GridFx...');
...
/**
 * open a grid item
 * %PSG: this is the animated effect of clicking on a grid item
 */
